...
public class LauncherRecentsView extends RecentsView<QuickstepLauncher, LauncherState>
    ...
    public void reset(boolean isCancelAnimation) {
        ...
        if(orientationHandler != null) {
            int rotation = (int) orientationHandler.getDegreesRotated();
            switch(rotation) {
                case 0:
                    setLayoutRotation(Surface.ROTATION_0, Surface.ROTATION_0);
                    break;
                case 90:
                    setLayoutRotation(Surface.ROTATION_90, Surface.ROTATION_90);
                    break;
                case 180:
                    setLayoutRotation(Surface.ROTATION_180, Surface.ROTATION_180);
                    break;
                case 270:
                    setLayoutRotation(Surface.ROTATION_270, Surface.ROTATION_270);
                    break;
            }
        } else {
            setLayoutRotation(Surface.ROTATION_0, Surface.ROTATION_0);
